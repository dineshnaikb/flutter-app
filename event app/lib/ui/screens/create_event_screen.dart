...
class _CreateEventScreenState extends State<CreateEventScreen> {
  ...
  @override
  void initState() {
    context.read<EventBloc>().add(EventInitial(
        uid: context.read<SettingsBloc>().state.uid,
        photo_url: context.read<SettingsBloc>().state.imageUrl));
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text(context.watch<EventBloc>().state.event_date),
...
Widget buildPopUp(BuildContext context, EventState event) {
  return AlertDialog(
    backgroundColor: Theme.of(context).secondaryBackgroundColor,
